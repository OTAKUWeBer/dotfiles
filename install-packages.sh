...
paru -S --noconfirm wl-clip-persist-git catppuccin-gtk-theme-mocha papirus-folders-catppuccin-git swaylock oh-my-zsh swaybg brightnessctl swaynag pulseaudio noto-fonts-emoji blueman visual-studio-code-bin swaylock
